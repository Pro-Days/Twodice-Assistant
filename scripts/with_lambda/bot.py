    ...
    async def send_log(self, log_type, var=None):
        ...
        if log_type == 1:
            ...
            embed_json = {
                ...
                "user_list": "```" + ", ".join([user.name for user in self.discord_client.users]) + "```",
            }
            ...
            await self.discord_client.get_channel(LOG_CHANNEL_ID).send(file=discord.File(image))
